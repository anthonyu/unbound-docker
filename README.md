...
Documentation for this image is stored right here in the [`README.md`](https://github.com/anthonyu/unbound-docker/blob/master/README.md).
...
file](https://github.com/anthonyu/unbound-docker/blob/master/LICENSE) for
details.
